    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.div 
  className="hidden sm:mb-8 sm:flex sm:justify-left"
  initial={{ opacity: 0, y: -20 }}
  animate={{ opacity: 1, y: 0 }}
  transition={{ delay: 0.2, duration: 0.6 }}
>
  <motion.div 
    className="relative px-3 py-1 text-gray-600 dark:text-gray-400 rounded-full text-sm/6 ring-1 ring-gray-900/10 dark:ring-gray-100/10 hover:ring-gray-900/20 dark:hover:ring-gray-100/20 overflow-hidden group cursor-pointer"
  ...
  >
    ...
    <span className="relative z-10 flex items-center gap-2">
      ...
      <a href="#" className="font-semibold text-primary group/link inline-flex items-center">
